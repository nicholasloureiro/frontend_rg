...
const Produtos = () => {
  ...
  const buscarProdutos = async (
    ...
    try {
      ...
      const response = await productService.buscarProdutos(
        page,
        search,
        tipo,
        marca
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      ...
      if (
        ...
        setUploadError(
          "Por favor, selecione um arquivo Excel (.xlsx, .xls) ou CSV válido."
        );
      ...
      <div className="produto-card">
        ...
        <div className="produto-info">
          ...
          <div className="produto-detalhes">
            <span className={`badge ${getTipoColor(produto.tipo)}`}>
              {produto.tipo}
            </span>
          ...
          <div className="produto-caracteristicas">
            ...
            <small>
              <strong>Cor:</strong> {produto.cor} ({produto.intensidade_cor})
            </small>
            <small>
            ...
            {produto.padronagem && (
              <small>
                <strong>Padronagem:</strong> {produto.padronagem}
              </small>
            )}
            {produto.botoes && (
              <small>
                <strong>Botões:</strong> {produto.botoes}
              </small>
            )}
            {produto.lapela && (
              <small>
                <strong>Lapela:</strong> {produto.lapela}
              </small>
            )}
          </div>
        </div>
    ...
    <div className="import-modal">
          ...
          <label htmlFor="fileInput" className="upload-label">
            <div className="upload-content">
              ...
              <small className="text-muted">
                {selectedFile
                  ? `Tamanho: ${(selectedFile.size / 1024 / 1024).toFixed(
                      2
                    )} MB`
      ...
      <div className="d-flex justify-content-end gap-2">
        ...
        {uploadLoading ? (
          <Button
            text={
              <span className="d-flex align-items-center">Importando...</span>
            }
            variant="primary"
